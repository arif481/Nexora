...
export const COLLECTIONS = {
  ...
  XP_EVENTS: 'xpEvents',
  ENTERTAINMENT_ITEMS: 'entertainmentItems',
  CONTACTS: 'contacts',
  ...
  ADMIN_VEHICLES: 'adminVehicles',
  ADMIN_MEDICATIONS: 'adminMedications',
  ADMIN_PETS: 'adminPets',
  COMMS_TEMPLATES: 'commsTemplates',
  COMMS_FOLLOWUPS: 'commsFollowups',
  PROJECTS: 'projects',
